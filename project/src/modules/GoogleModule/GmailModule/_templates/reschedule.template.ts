          ...
          <tr>
            <td style="padding:32px 32px 16px;color:#111827;">
              ...
              <p style="margin:0 0 20px;font-size:15px;color:#374151;">
                We've received your service request, but in order to confirm this booking in our system, we'd like to ask to reschedule 
                this service to:
              </p>
              ...
              <p style="margin-top:20px; margin-bottom:30px; font-size:15px; color:#374151; text-align:center;">
                Please reply back to us or give us a call to let us know you've received this, so we can lock your booking in place. 
                You can reach us at:
                <br><br>

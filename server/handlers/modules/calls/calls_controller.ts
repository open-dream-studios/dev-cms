...
export const handleIncomingCall = async (req: Request, res: Response) => {
  try {
    ...
    const vr: any = new VoiceResponse();
...
export const declineCallHandler = async (req: Request, res: Response) => {
  try {
 ...
 */
export const callStatusHandler = async (req: Request, res: Response) => {
  try {
    // console.log("--- STATUS ---");
    // console.log(

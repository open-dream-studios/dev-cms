// server/handlers/webohooks/schedule/schedule_controllers.ts
...
import { syncStripeSubscriptionsFromStripeFunction } from "../../payments/subscriptions/subscriptions_repositories.js";
import { Request, Response } from "express";
import { PoolConnection } from "mysql2/promise";

export const runDailySchedule = async (
  req: Request,
  res: Response,
  ...
  try {
    ...
    // ========================
    console.log("▶️ Importing subscription list...");
